...
Platform: Windows PowerShell x64, stock laptop; exact CPU/DIMM inventory was not captured in the original transcript.

The complete interpretation, exact numbers and caveats are in:

- [`../../docs/16-STOCK-LAPTOP-RAM-LOOKUP-COMPUTE-2026-09-16.md`](../../docs/16-STOCK-LAPTOP-RAM-LOOKUP-COMPUTE-2026-09-16.md)
- [`results-2026-09-16.csv`](results-2026-09-16.csv)
...
Then benchmark each path after JIT warm-up, with the same generated codebooks, the same activation codes and exact checksum/equality validation.

For publication-grade comparison, port the direct and lookup paths to native C/C++ and add AVX2/AVX-512 baselines plus hardware performance counters.

## Acceptance rules

A run is valid only if:

1. all compared paths use the same logical input/codebooks for that version;
2. checksums/output arithmetic match exactly;
3. build/warm-up time is excluded from generation throughput;
